...
class RAPOExplorationReplacementPOAARO(_RAPOBase):
    """RAPO-EPR POA->ARO.

    Low-level Relay / Exploration Phase Replacement.
    Keep the Pufferfish-POA two-phase framework.
    Replace POA Phase 1 Predator Attack with ARO Detour Foraging.
    Keep POA Phase 2 Defense Mechanism.
    ...
    def optimize(
        ...
        try:
            for t in range(1, self.max_iterations + 1):
                for i in range(self.population_size):
                    candidate_1 = self._aro_detour_foraging(i, population, t)
                    ...
                    candidate_2 = self._poa_defense_mechanism(i, population, t)
        ...
        return OptimizationResult(
            ...
            metadata={
                "algorithm": "RAPO_EPR_POA_ARO",
                "hybrid_type": "Low-level Relay / Exploration Phase Replacement",
                "framework": "POA",
                "replaced_phase": "POA Phase 1 - Predator Attack",
                "replacement_operator": "ARO Detour Foraging",
                "kept_operator": "POA Phase 2 - Defense Mechanism",
...
if __name__ == "__main__":
    ...
    optimizer = RAPOExplorationReplacementPOAARO(
        population_size=30,
        max_iterations=80,
        lower_bound=-100.0,
        upper_bound=100.0,
